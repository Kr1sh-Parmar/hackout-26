...
RENAME = {
    "shortwave_radiation": "ghi_wm2", "direct_normal_irradiance": "dni_wm2",
    "diffuse_radiation": "dhi_wm2", "direct_radiation": "direct_radiation_wm2",
    "terrestrial_radiation": "terrestrial_radiation_wm2",
    "temperature_2m": "temperature_2m_c", "dew_point_2m": "dew_point_2m_c",
    "relative_humidity_2m": "relative_humidity_2m_pct",
    "surface_pressure": "surface_pressure_hpa", "pressure_msl": "pressure_msl_hpa",
    "cloud_cover": "cloud_cover_pct", "cloud_cover_low": "cloud_cover_low_pct",
    "cloud_cover_mid": "cloud_cover_mid_pct", "cloud_cover_high": "cloud_cover_high_pct",
    "wind_speed_10m": "wind_speed_10m_ms", "wind_speed_100m": "wind_speed_100m_ms",
    "wind_direction_10m": "wind_direction_10m_deg",
    "wind_direction_100m": "wind_direction_100m_deg",
    "wind_gusts_10m": "wind_gusts_10m_ms", "precipitation": "precipitation_mm",
    "rain": "rain_mm", "snowfall": "snowfall_cm", "snow_depth": "snow_depth_m",
    "visibility": "visibility_m", "is_day": "is_day",
}
META = ["grid_point_id", "weight_solar", "weight_wind", "nwp_model",
...
def main() -> None:
    ...
    front = ["region_id", "run_ts_utc", "valid_ts_utc", "lead_hours", "forecast_vintage",
             "run_ts_is_approx", "nwp_model", "grid_point_id", "weight_solar", "weight_wind"]
    out = out[front + [c for c in out.columns if c not in front]]
    _write(out.sort_values(key).reset_index(drop=True), SILVER, "weather_nwp_india")

    print(f"    {out.grid_point_id.nunique()} grid points x "
          f"{out.nwp_model.nunique()} models")
